...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center">Souvenir Maluku</h1>
    <p class="text-center">Harga: Rp 63.000</p>
    <p>Souvenir khas Maluku berupa kerajinan tangan, kain tradisional, dan barang unik lainnya.</p>
    ...
    <img src="{{ asset('storage/images/souvenir maluku.jpeg') }}" alt="Souvenir Maluku" class="img-fluid w-50">
  </div>
</body>
